...
const I18N = {
  id: {
    ...
    hero_title: 'Baru di Medan?<br>Tanya <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> aja',
  ...
  en: {
    ...
    hero_title: 'New in Medan?<br>Just ask <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span>',
  ...
  btk: {
    ...
    hero_title: 'Parmodal di Medan?<br>Tanya <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> ro',
  ...
  jv: {
    ...
    hero_title: 'Anyar tekan Medan?<br>Mangga <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span>',
  ...
  ms: {
    ...
    nav_about: 'Tentang',
    hero_location: 'Kota Medan, Sumatera Utara, Indonesia',
    hero_title: 'Baru di Medan?<br>Tanya <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> saja',
  ...
  min: {
    ...
    hero_title: 'Baruah ka Medan?<br>Tanyo <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> jo',
  ...
  su: {
    ...
    nav_about: 'Ngeunaan',
    hero_location: 'Kota Medan, Sumatera Utara',
    hero_title: 'Anyar ka Medan?<br>Mintawlos <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> wae',
  ...
  ace: {
    ...
    nav_about: 'Tentang',
    hero_location: 'Kota Medan, Sumatera Utara',
    hero_title: 'Baro Meugang di Medan?<br>Tanyo <span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> Mantong',
