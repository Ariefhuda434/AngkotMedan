...
const I18N = {
  id: {
    ...
    hero_title: 'Cari Rute<br><span class="text-[#ffd731] relative inline-block">Angkot<svg class="absolute -bottom-1 left-0 w-full" viewBox="0 0 200 8" fill="none"><path d="M2 6C50 2 150 2 198 6" stroke="#000000" stroke-width="3" stroke-linecap="round"/></svg></span> Medan',
    hero_subtitle: 'Ketik asal dan tujuan, langsung tahu angkot mana yang harus dinaiki. 118 trayek, 500+ halte, gratis.',
    search_title: 'Cari Rute Angkot',
    label_origin: 'Dari mana, lek?',
    label_dest: 'Ke mana, lek?',
    placeholder_origin: 'Contoh: USU, RS Adam Malik, Sun Plaza...',
    placeholder_dest: 'Contoh: Mall Centre Point, Istana Maimun, Amplas...',
    ...
    explorer_desc: 'Jelajahi seluruh trayek angkot di Medan. Klik kartu untuk lihat rute detail.',
    explorer_search: 'Cari nomor trayek atau nama operator...',
    about_title: 'Tentang Angkot Medan Finder',
    popular_title: 'Rute Populer',
    about_problem: 'Masalah Transit Medan',
    about_problem_desc: 'Setiap hari, jutaan warga Medan naik angkot. Tapi mengetahui rute yang tepat dari A ke B masih jadi teka-teki tanpa peta resmi yang jelas.',
    about_how: 'Cara Kerja',
    about_how1: 'Ketik Asal & Tujuan',
    about_how1_desc: 'Masukkan nama halte, jalan, atau landmark. Auto-suggest bantu kamu nemu nama yang tepat.',
    about_how2: 'Lihat Rute',
    about_how2_desc: 'Sistem cari rute langsung dan rute transfer. Tampilkan warna livery, nomor angkot, dan daftar halte.',
    ...
    about_data_desc: 'Data 118 trayek angkot dikumpulkan dari berbagai sumber publik, papan informasi halte, dan konfirmasi komunitas pengguna angkot di Medan.',
    about_back: 'Beranda',
  ...
  en: {
    ...
    hero_title: 'Find Angkot Routes in Medan',
    hero_subtitle: 'Type origin and destination to find the right angkot. 118 routes, 500+ stops, free.',
    search_title: 'Find Angkot Route',
    label_origin: 'Where from?',
    label_dest: 'Where to?',
    placeholder_origin: 'e.g. USU, Adam Malik Hospital, Sun Plaza...',
    placeholder_dest: 'e.g. Centre Point Mall, Maimun Palace, Amplas...',
    ...
    explorer_desc: 'Explore all 118 angkot routes in Medan. Click card for details.',
    explorer_search: 'Search by route number or operator...',
    about_title: 'About Angkot Medan Finder',
    popular_title: 'Popular Routes',
    about_problem: 'Medan Transit Problem',
    about_problem_desc: 'Millions ride angkot daily, but finding the right route from A to B remains a puzzle without clear official maps.',
    about_how: 'How It Works',
    about_how1: 'Type Origin & Destination',
    about_how1_desc: 'Enter stop name, street, or landmark. Auto-suggest helps find the right location.',
    about_how2: 'View Routes',
    about_how2_desc: 'System finds direct and transfer routes with livery colors, numbers, and stop lists.',
    about_how3: 'Ride Angkot',
    about_how3_desc: 'Recognize angkot by livery color and route number.',
    about_livery: 'Livery Color Guide',
    about_livery_desc: 'Livery colors indicate operators or route groups.',
    about_data: 'About Data',
    about_data_desc: 'Data collected from public sources, stop information boards, and Medan commuter communities.',
    about_back: 'Home',
  ...
  jv: {
    ...
    hero_title: 'Golek Rute Angkot Medan',
    hero_subtitle: 'Ketik asal lan tujuan, langsung ngerti numpak angkot apa.',
    search_title: 'Golek Rute Angkot',
    label_origin: 'Saka endi?',
    label_dest: 'Menyang endi?',
    placeholder_origin: 'Conto: USU, Sun Plaza...',
    placeholder_dest: 'Conto: Mall Centre Point, Amplas...',
    ...
    popular_title: 'Rute Populer',
    about_problem: 'Masalah Transit Medan',
    about_problem_desc: 'Golek rute angkot ing Medan asring bingungake tanpa peta sing jelas.',
    about_how: 'Carane Kerja',
    about_how1: 'Ketik Asal & Tujuan',
    about_how1_desc: 'Ketik jeneng halte utawa panggonan.',
    ...
    about_data_desc: 'Data dikumpulake saka sumber umum.',
    about_back: 'Omah',
...
function renderDirectCard(result) {
  ...
  return `
    <div class="bg-white border-2 border-[#000000] shadow-brutal rounded-2xl overflow-hidden p-4 sm:p-6">
      <div class="flex items-start gap-3 sm:gap-4 mb-4">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2 mb-1">
            ...
            <span class="text-[10px] font-display font-bold px-2 py-0.5 rounded-pill bg-[#000]/5">${livery.label}</span>
          </div>
          <p class="font-body text-xs text-[#000]/50 truncate">${route.operator} • ${subWaypoints.length} halte</p>
        </div>
      </div>
      ...
      <div class="bg-[#f0f7ff] border border-[#000]/10 rounded-xl p-3 sm:p-4 text-xs font-body text-[#000]/70 mb-4 leading-relaxed">
        Naik dari <strong>${originStop}</strong>, turun langsung di <strong>${destStop}</strong> (${subWaypoints.length} halte).
      </div>
  ...
  return `
    <div class="bg-white border-2 border-[#000000] shadow-brutal rounded-2xl overflow-hidden p-4 sm:p-6">
      <div class="flex items-center gap-2 mb-4">
        ...
        <span class="ml-auto text-[10px] font-display font-bold bg-[#ffd731] text-[#000000] px-2.5 py-1 rounded-pill border-2 border-[#000000] shadow-brutal-sm">1x Pindah</span>
      </div>
      <div class="bg-[#f0f7ff] border border-[#000]/10 rounded-xl p-3 sm:p-4 text-xs font-body text-[#000]/70 mb-4 space-y-2">
        <div class="flex items-start gap-2">
          <span class="w-5 h-5 rounded-full bg-[#ffd731] border border-[#000] flex items-center justify-center font-display font-bold text-[10px] shrink-0">1</span>
          <p>Naik <strong>#${leg1.route.nomor}</strong> dari <strong>${leg1.originStop}</strong> &rarr; turun & pindah di <strong>${transferStop}</strong>.</p>
        </div>
        <div class="flex items-start gap-2">
          <span class="w-5 h-5 rounded-full bg-[#4da2ff] text-white border border-[#000] flex items-center justify-center font-display font-bold text-[10px] shrink-0">2</span>
          <p>Sambung <strong>#${leg2.route.nomor}</strong> dari <strong>${transferStop}</strong> &rarr; turun di <strong>${leg2.destStop}</strong>.</p>
        </div>
      </div>
